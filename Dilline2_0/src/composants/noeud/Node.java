...
/**
 * The {@code Node} class implements the
 * {@code SensorNodeP2PImplI}, {@code RequestingImplI} interfaces
...
protected Node(NodeInfoI node, ArrayList<SensorDataI> sensors ) throws Exception{	
			...
			this.inboundPortRequesting = new RequestingInboundPort(this, CLIENT_POOL_URI, NODE_PLUGIN_URI);
			this.outboundPortRequestR = new RequestResultOutboundPort(this);
			this.inboundPortP2P = new SensorNodeP2PInboundPort(this, NODE_POOL_URI, NODE_PLUGIN_URI);
	...
	public void ask4Connection(NodeInfoI neighbour) throws Exception {
	    ...
	    SensorNodeP2POutboundPort newOutboundPort = new SensorNodeP2POutboundPort(this);
	...
	public QueryResultI execute(RequestContinuationI request) throws Exception {
	    ...
	    try {
	    	//vÃ©rifie si le noeud n'a pas dÃ©jÃ  Ã©valuer cette requÃªte
    ...
    public void start() throws ComponentStartException
    {
        ...
        try {
          ...
          //connection entre node et clock
        	...
        	//node doit register auprÃ¨s du registre
			this.doPortConnection(
	...
	public void	execute() throws Exception
	{
		...
		long dRegister = ac.nanoDelayUntilInstant(i1); // dÃ©lai en nanosecondes		
		
		Instant i2 = ac.getStartInstant().plusSeconds(CVM.timeBeforeUpdatingSensorValue);
		long dUpdateSensors = ac.nanoDelayUntilInstant(i2); // dÃ©lai en nanosecondes		
